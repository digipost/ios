...
class ReceiptView: UIView {
	...
	func setupLayers(){
		...
		self.layerWithAnims = [kvitto, path, rectangle, rectangle2, rectangle3, kort, path2, rectangle4, litenkvadrat, roundedrect, rectangle5, rectangle6]
	}
	...
	func setupLayerFrames(){
		if kvitto != nil{
			...
			kvitto.frame = CGRectMake(0.51362 * kvitto.superlayer.bounds.width, 0.16607 * kvitto.superlayer.bounds.height, 0.17303 * kvitto.superlayer.bounds.width, 0.1416 * kvitto.superlayer.bounds.height)
			kvitto.setValue(8.8 * CGFloat(M_PI)/180, forKeyPath:"transform.rotation")
		}
		if path != nil{
		...
		if kort != nil{
			...
			kort.frame = CGRectMake(0.30159 * kort.superlayer.bounds.width, 0.25191 * kort.superlayer.bounds.height, 0.27666 * kort.superlayer.bounds.width, 0.1006 * kort.superlayer.bounds.height)
			kort.setValue(356 * CGFloat(M_PI)/180, forKeyPath:"transform.rotation")
		}
		if path2 != nil{
			path2.frame = CGRectMake(0.00278 * path2.superlayer.bounds.width, 0, 0.99445 * path2.superlayer.bounds.width,  path2.superlayer.bounds.height)
			path2.path  = path2PathWithBounds(path2.bounds).CGPath;
		}
		if rectangle4 != nil{
			rectangle4.frame = CGRectMake(0, 0.23448 * rectangle4.superlayer.bounds.height,  rectangle4.superlayer.bounds.width, 0.10734 * rectangle4.superlayer.bounds.height)
			rectangle4.path  = rectangle4PathWithBounds(rectangle4.bounds).CGPath;
		}
		if litenkvadrat != nil{
			litenkvadrat.frame = CGRectMake(0.07555 * litenkvadrat.superlayer.bounds.width, 0.4851 * litenkvadrat.superlayer.bounds.height, 0.18659 * litenkvadrat.superlayer.bounds.width, 0.20749 * litenkvadrat.superlayer.bounds.height)
		}
		if roundedrect != nil{
			roundedrect.frame = CGRectMake(0.04101 * roundedrect.superlayer.bounds.width, 0.22054 * roundedrect.superlayer.bounds.height, 1.04772 * roundedrect.superlayer.bounds.width, 1.09459 * roundedrect.superlayer.bounds.height)
			roundedrect.path  = roundedRectPathWithBounds(roundedrect.bounds).CGPath;
		}
		if rectangle5 != nil{
			rectangle5.setValue(0, forKeyPath:"transform.rotation")
			rectangle5.frame = CGRectMake(0.30782 * rectangle5.superlayer.bounds.width, 0.4793 * rectangle5.superlayer.bounds.height, 0.58116 * rectangle5.superlayer.bounds.width, 0 * rectangle5.superlayer.bounds.height)
			rectangle5.setValue(180 * CGFloat(M_PI)/180, forKeyPath:"transform.rotation")
			rectangle5.path  = rectangle5PathWithBounds(rectangle5.bounds).CGPath;
		}
		if rectangle6 != nil{
			rectangle6.setValue(0, forKeyPath:"transform.rotation")
			rectangle6.frame = CGRectMake(0.3158 * rectangle6.superlayer.bounds.width, 0.62932 * rectangle6.superlayer.bounds.height, 0.22621 * rectangle6.superlayer.bounds.width, 0 * rectangle6.superlayer.bounds.height)
			rectangle6.setValue(180 * CGFloat(M_PI)/180, forKeyPath:"transform.rotation")
